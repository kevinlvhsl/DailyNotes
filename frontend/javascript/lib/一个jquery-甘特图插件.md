...
> 最近的项目需要用到甘特图，这玩意儿，手写需要到啥时候去了。 果断上百度找插件，因为是react开发的，但是react-gantt没有什么好用的插件。 这时当然会想到万能的jquery
和它丰富的插件库。 因为是在pc端使用，不用担心多引入一个jquery而影响加载速度。

jquery.fn.gantt.js 

[使用方法](http://www.cnblogs.com/marksfly/p/4561165.htm)
		...
		$(function() {
			...
			$(".gantt").gantt({
				source: [{
					...
					values: [{
						id: "t01",
						from: "/Date(1471204919293)/",
						to: "/Date(1498204919293)/",
				...
				onAddClick: function(dt, rowId) {
					console.log('onAddClick:', dt, rowId)
					// alert("Empty space clicked - add an item!");
				},
				onLeftItemClick: function (id) {
...
(function ($) {
    ...
    $.fn.gantt = function (options) {
        ...
        var settings = {
            source: null,
            itemsPerPage: 7,
            months: ["January一月", "February二月", "March三月", "April四月", "May五月", "June", "July", "August", "September", "October", "November", "December"],
            dow: ["S日", "M一", "T二", "W三", "T四", "F五", "S六"],
            startPos: new Date(),
            navigate: "buttons",
            scale: "days",
            useCookie: false,
            ...
            onLeftItemClick: function (data) { return;},
            scrollToToday: true
        };
        ...
        var core = {
            ...
            leftPanel: function (element) {
                ...
                ganttLeftPanel.on('click', '.row', function(e){
                    settings.onLeftItemClick($(this).data("id"));
                })
                ...
                ganttNavigate = $('<div class="navigate" />')
                    .append($('<div class="nav-slider" />')
                        .append($('<div class="nav-slider-left" />')
                            .append($('<span role="button" class="nav-link nav-page-back" title="上一页"/>')
                                .html('&lt;')
                                .click(function () {
                            ...
                            .append($('<span role="button" class="nav-link nav-page-next" title="下一页"/>')
                                .html('&gt;')
                                .click(function () {
                                    core.navigatePage(element, 1);
                                }))
                            .append($('<span role="button" class="nav-link nav-now" title="定位到当前时间"/>')
                                .html('&#9679;')
                                .click(function () {
                                    core.navigateTo(element, 'now');
                                }))
                            .append($('<span role="button" class="nav-link nav-prev-week"  title="上一周期"/>')
                                .html('&lt;&lt;')
                                .click(function () {
                        ...
                        .append($('<div class="nav-slider-content"  title="滚动日期"/>')
                        ...
                        .append($('<span role="button" class="nav-link nav-next-week"  title="下一周期"/>')
                                .html('&gt;&gt;')
                                .click(function () {
                                    if (settings.scale === 'hours') {
                                        core.navigateTo(element, tools.getCellSize() * -8);
                            ...
                            .append($('<span role="button" class="nav-link nav-zoomIn"  title="缩小视图"/>')
                                .html('&#43;')
                                .click(function () {
                                    core.zoomInOut(element, -1);
                                }))
                            .append($('<span role="button" class="nav-link nav-zoomOut"  title="放大视图"/>')
                                .html('&#45;')
                                .click(function () {
                                    core.zoomInOut(element, 1);
                                }))
...
.fn-gantt .dataPanel {
    ...
    background-image: url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABgAAAAYAQMAAADaua+7AAAABlBMVEX////l5eUJgtBrAAAAEUlEQVQI12NgYGCkGf7//z8ACsEDFTucczgAAAAASUVORK5CYII=");
...
.fn-gantt .navigate .nav-slider-button {
    width: 17px;
    height: 60px;
    background-image: url("data:image/png;base64,");
...
.fn-gantt .nav-link {
    ...
    background-image: url("data:image/png;base64,") !important;
...
.fn-gantt-loader {
    ...
    background-image: url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADIAAAAyAQMAAAAk8RryAAAABlBMVEWZmZnMzMzueGz2AAAAAnRSTlNKSuoMwjkAAAAoSURBVBjTY+BwEmhR5HBgAJJAZgODIliAgcEJLMDA0AIWYBhVRx91AIv+Q0V/WvzyAAAAAElFTkSuQmCC");
    z-index: 30;
}
